...
/**
 * Same idea as `pointsBadgeClass`, but for a single match/jornada score
 * rather than a season total or average — six tiers instead of five, always
 * a real color (no neutral/black tier), and dedicated azure/violet tones
 * that don't collide with the position-tag colors (`hq-med`, `hq-def`).
 */
